...
static const u8 sText_IsThisTradeOkay[] = _("¿Aceptas el trato?");
...
static const u8 sText_Trade[] = _("Intercambio");
static const u8 sText_CancelTrade[] = _("¿Cancelar?");
static const u8 sJPText_PressBButtonToQuit[] = _("Bボタン　で　もどります");
static const u8 sText_Summary2[] = _("Datos");
static const u8 sText_Trade2[] = _("Intercambio");
static const u8 sText_CommunicationStandby[] = _("{COLOR DARK_GRAY}{HIGHLIGHT WHITE}{SHADOW LIGHT_GRAY}Esperando conexíon…\nEspere.");
static const u8 sText_TheTradeHasBeenCanceled[] = _("{COLOR DARK_GRAY}{HIGHLIGHT WHITE}{SHADOW LIGHT_GRAY}Se canceló\nel intercambio.");
static const u8 sText_OnlyPkmnForBattle[] = _("Es tu único\nPOKéMON disponible.");
static const u8 sText_WaitingForYourFriend[] = _("{COLOR DARK_GRAY}{HIGHLIGHT WHITE}{SHADOW LIGHT_GRAY}Esperando que tu amigo\ntermine…");
