...
static const u8 LandmarkName_FlowerShop[] = _("Floreria");
static const u8 LandmarkName_PetalburgWoods[] = _("Bosque Petalia");
static const u8 LandmarkName_MrBrineysCottage[] = _("Cabaña del Sr. Arenque");
static const u8 LandmarkName_AbandonedShip[] = _("Nao Abandonada");
static const u8 LandmarkName_SeashoreHouse[] = _("Casa de Playa");
static const u8 LandmarkName_SlateportBeach[] = _("Playa Portuaria");
static const u8 LandmarkName_CyclingRoad[] = _("Camino Bicis");
static const u8 LandmarkName_NewMauville[] = _("Neo Malvalona");
static const u8 LandmarkName_TrickHouse[] = _("Casa Treta");
static const u8 LandmarkName_OldLadysRestShop[] = _("Hotel de la Abuelita");
static const u8 LandmarkName_Desert[] = _("Desierto");
static const u8 LandmarkName_WinstrateFamily[] = _("Familia Estratega");
...
static const u8 LandmarkName_RusturfTunnel[] = _("Tunel Fervergal");
static const u8 LandmarkName_PokemonDayCare[] = _("Guardería Pokémon");
static const u8 LandmarkName_SafariZoneEntrance[] = _("Entrada a Zona Safari");
static const u8 LandmarkName_MtPyre[] = _("Monte Pírico");
static const u8 LandmarkName_ShoalCave[] = _("Cueva Cardumen");
static const u8 LandmarkName_SeafloorCavern[] = _("Cueva Abisal");
...
static const u8 LandmarkName_AncientTomb[] = _("Tumba Ancestral");
static const u8 LandmarkName_SealedChamber[] = _("Cámara Sellada");
static const u8 LandmarkName_FossilManiacsHouse[] = _("Casa del Fósilmaniaco");
static const u8 LandmarkName_HuntersHouse[] = _("Casa del Cazatesoros");
...
static const u8 LandmarkName_TrainerHill[] = _("Colina del Entrenador");
